...
public class ProfissionaisController {
    ...
    public ResponseEntity salvar(@RequestBody ProfissionaisDto profissionaisDto){
       ...
       // return prof_serv.save(profissionais);
    }

    @PutMapping(path = "/profissionais")
    public Profissionais editar(@RequestBody Profissionais profissionais){
        return prof_serv.save(profissionais);
    }

    @DeleteMapping(path = "/delete/{id_prof}")
    public void excluir(@PathVariable("id_prof") Integer id_prof){
